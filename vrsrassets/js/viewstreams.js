...
function loadStreams()
{
    ...
    .then((data) =>
    {
        ...
        for (var i = 0; i < streams.length; i++)
        {
            ...
            if (game.length > 0)
            {
                gameImage = `<div class="game-cover" title="${game[0].name}"><a href="${"/" + game[0].abbreviation}"><img src="https://www.speedrun.com/gameasset/${game[0]["api_id"]}/cover"></a></div>`;
            }

            streamsInnerContainer.innerHTML += `<div class="column is-3"><div class="stream-top">
